...
/*
  ...
  */
  ...
  if($i == 1){
    ...
    $resultLast = round((int)$resultRow['lastRecord']-5);
    $resultMax = round((int)$resultRow['maxRecord']-5);
    $resultMin = round((int)$resultRow['minRecord']-5);
    ...
    $resultLast = round((int)$resultRow['lastRecord']/9+4); // faraneith to celsius --> -32*(5/9))
    $resultMax = round((int)$resultRow['maxRecord']/9+4);
    $resultMin = round((int)$resultRow['minRecord']/9+4);
